...
@ContextConfiguration(locations= {      // 테스트시 필요한 빈(Bean)을 찾을 장소를 작성합니다. (root-context.xml의 4개 빈과 UserDAO 빈)
    "file:src/main/webapp/WEB-INF/spring/root-context.xml",               // root-context
