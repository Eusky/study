...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    Calculator calculator = (Calculator)ctx.getBean("calc1");
    ...
    System.out.println(calculator.getSubstractor().subtract(3, 5));
    System.out.println(calculator.getMultiplyer().multiply(1, 2, 3, 4, 5));
