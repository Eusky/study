 ...
 * @Configuration
 * 
 * 1. 클래스 레벨 어노테이션으로, 해당 클래스가 스프링 빈 설정 소스임을 나타냅니다.
 *    (나는 Spring Bean Configuration File 입니다.)
...
public class AppConfig {
  ...
  public Calculator calc() {
    ...
    calculator.setSubstractor(sub());
    calculator.setMultiplyer(mul());
