...
public class MvcControllerA {
   ...
   * 2. 클라이언트 요청 주소와 요청 메소드(GET, POST 등)를 컨트롤러의 메소드와 연결하는 역할을 주로 수행합니다. 
  ...
  public void methodB() {
    System.out.println("메소드B 동작");
    /*
     * return이 없는 경우 처리 과정
     * 
     * 1. 요청 주소를 반환값으로 해석합니다. (즉 "/a/detail" 값을 반환값으로 해석합니다. )
     * 2. ViewResolver는 prefix 값을 반환값 앞에 추가하고, suffix 값을 반환값 뒤에 추가합니다. 
     *    "/WEB-INF/views/a/detail.jsp"
     */
  }
  ...
  public ModelAndView methodC() {
     ...
     * 2. HTTP 상태코드, forward할 데이터 등을 함께 객체에 담아 처리할 수 있습니다.
     */
  }
