...
public class BankAccount {
  ...
  public void deposit(long money) throws DepositException {
    /* 구현 */
    if(money < 0) {
      throw new DepositException("마이너스 금액은 입금할 수 없습니다.");
    }
    balance += money;
   ...
   */
  public long withdrawal(long money) throws WithdrawlException {
    /* 구현 */
    if(money < 0) {
      throw new WithdrawlException("마이너스 금액은 출금할 수 없습니다.");
    }
    else if(money > balance) {
      throw new WithdrawlException("계좌에 잔고가 부족합니다.");
    }
    balance -= money;
   ...
   */
  public void transfer(BankAccount bankAccount, long money) throws DepositException, WithdrawlException {
