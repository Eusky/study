 ...
 * 3. 상속 관계를 가진 예외 처리 시에는 반드시 자식 타입 예외를 먼저 catch 블록으로 작성해야 합니다.
 */
 ...
 * 4. 자바에서 발생하는 예외 대부분은 java.lang.Exception 클래스를 상속받아서 구현되어 있습니다.
 * 5. 주요 메소드
 *  1) getMessage() : 예외 메시지를 반환합니다.
 *  2) printStackTrace() : 예외 발생 위치를 추척하여 출력합니다.
 *  3) 
 */
...
public class Main {
  ...
  public static void multiCatch() {
    try {
      ...
      System.out.println("정수값만 변환 후 누적할 수 있습니다. " + e.getMessage());
    }
    catch(ArrayIndexOutOfBoundsException e) { //---------------------------------------- RuntimeException 하위 예외 타입
      System.out.println("사용할 수 없는 인덱스가 사용되었습니다. " + e.getMessage());
    }
