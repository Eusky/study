 ...
 *    2) 인터페이스는 구현(implements)합니다. 상속받는다고 표현하지 않습니다.
 *    3) 상속과 다르게 다중 구현이 가능합니다. 2개 이상의 인터페이스를 구현할 수 있습니다.
 *    4) 다형성을 지원합니다. 인터페이스를 구현 클래스 객체들의 타입으로 사용할 수 있습니다.
 *    5) 인터페이스의 구현클래스들은 반드시 모든 추상 메소드를 오버라이드해야 합니다.
 */
