...
# 1. 고객 테이블에서 각 고객의 이름별(first name)로 등록된 고객 수를 구하고, 고객 수가 2명 이상인 이름만 조회하세요.
/*
  first_name  cnt
  KELLY        2
  TRACY        2
...
/*
    ...
    158
*/
SELECT COUNT(customer_id) AS five_letter_names
FROM customer
...
FROM rental
WHERE TIMESTAMPDIFF(DAY, rental_date, return_date) >= 9;
