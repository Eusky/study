...
public class BoardDao {
  ...
  // 조회 (제목과 내용 검색)
  public List<BoardDTO> findBoardsUsingQuery(Map<String, String> map) {
    SqlSession ss = factory.openSession();
  ...
  // 조회 (날짜 검색)
  public List<BoardDTO> findBoardsUsingDate(Map<String, String> map) {
    SqlSession ss = factory.openSession();
  ...
  // 조회1 (통합검색1)
  public List<BoardDTO> findBoards1(Map<String, String> map) {
    SqlSession ss = factory.openSession();
  ...
  // 조회2 (통합검색2)
  public List<BoardDTO> findBoards2(Map<String, String> map) {
    SqlSession ss = factory.openSession();
  ...
  // 삭제 (목록)
  public int deleteBoards(String[] bids) {
    SqlSession ss = factory.openSession(false); // 수동 커밋으로 설정
    int count = ss.delete(namespace + "deleteBoards", bids);
    if(count == bids.length) ss.commit(); // 성공 시 수동으로 커밋하기 
    ss.close();
    return count;
  }
